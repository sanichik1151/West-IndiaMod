...
// CAMERA_MAX_HEIGHT = 9000.0,					defines.lua   (reload defines)
...
static const float GB_CAM_MAX = 45.0f;
static const float GB_CAM_MAX_FILLING_CLAMP = 0.92f; // 0 to 1 value for clamping the fill when camera is at max distance
...
static const float SEC_MAP_TILE = 2000.0f;
